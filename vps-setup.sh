...
section_1() {
    ...
    # ── SSH keepalive：防止长时间运行脚本时 SSH 断连 ──────────────────────────
    info "配置 SSH keepalive..."
    ...
    ok "SSH keepalive 已配置（60s × 10次，最长容忍10分钟无响应）"
}
...
section_7() {
    ...
    echo -e "${YELLOW}  重启后请等待 1~2 分钟再登录，登录后建议再手动 reboot 一次${NC}"
    echo -e "${YELLOW}  以确保 BBRx 内核参数完全生效。${NC}"
    echo -e "${YELLOW}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
    sleep 10
    reboot
}
